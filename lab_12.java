...
public class lab_12 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Due to this I have decided to show the total sales for question 1 and total commissions for question 2.
            ...
            salesPersonList.stream().forEach(s -> System.out.printf("%-18s | $%.2f%n",s.name, s.totalSales));
